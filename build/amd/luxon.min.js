define(["exports"], function(e) {
    ...
    ut = (function() {
      function e(e, t, n) {
        ...
        if (((this.opts = n), (this.hasIntl = J()), e.zone.universal && this.hasIntl)) {
          var i = (e.offset / 60) * -1;
          i >= -14 && i <= 12 && i % 1 == 0
            ? ((r = i >= 0 ? "Etc/GMT+" + i : "Etc/GMT" + i), (this.dt = e))
            : ((r = "UTC"),
              n.timeZoneName
                ? (this.dt = e)
                : (this.dt = 0 === e.offset ? e : ar.fromMillis(e.ts + 60 * e.offset * 1e3)));
            ...
            ot(
              ...
              function() {
                if (!t.meridiemCache) {
                  ...
                  t.meridiemCache = [ar.utc(2016, 11, 13, 9), ar.utc(2016, 11, 13, 19)].map(
                    function(n) {
        ...
        (t.eras = function(e, t) {
          ...
          return (
            ...
            ot(this, e, t, Ie, function() {
              ...
              return (
                n.eraCache[e] ||
                  (n.eraCache[e] = [ar.utc(-40, 1, 1), ar.utc(2017, 1, 1)].map(function(e) {
  ...
  var Et = /^-?P(?:(?:(-?\d{1,9})Y)?(?:(-?\d{1,9})M)?(?:(-?\d{1,9})W)?(?:(-?\d{1,9})D)?(?:T(?:(-?\d{1,9})H)?(?:(-?\d{1,9})M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,9}))?S)?)?)$/;
  function Dt(e) {
    var t = e[0],
      n = e[1],
      r = e[2],
  ...
  function At(e) {
    var t = e[1],
      ...
      o = e[5],
      a = e[6];
    return [Vt(t, e[7], n, r, i, o, a), Re.utcInstance];
  }
  ...
  var rn = (function() {
    ...
    return (
      ...
      (t.plus = function(e) {
        ...
        for (var t, n = on(e), r = {}, i = c(Xt); !(t = i()).done; ) {
          var o = t.value;
      ...
      (t.set = function(t) {
        return this.isValid
          ? tn(this, { values: Object.assign(this.values, de(t, e.normalizeUnit, [])) })
          : this;
      }),
      ...
      (t.normalize = function() {
        ...
        return (
          (function(e, t) {
            en.reduce(function(n, r) {
              return R(t[r]) ? n : (n && nn(e, t, n, t, r), r);
            }, null);
          })(this.matrix, e),
          tn(this, { values: e }, !0)
        );
      ...
      (t.shiftTo = function() {
        ...
        for (var i, o, a = {}, u = {}, s = this.toObject(), l = c(Xt); !(o = l()).done; ) {
          var f = o.value;
          if (n.indexOf(f) >= 0) {
            i = f;
            var d = 0;
            ...
            for (var y in ((a[f] = m), (u[f] = d - m), s))
              Xt.indexOf(y) > Xt.indexOf(f) && nn(this.matrix, s, y, a, f);
          } else W(s[f]) && (u[f] = s[f]);
        }
        for (var v in u) 0 !== u[v] && (a[i] += v === i ? u[v] : u[v] / this.matrix[i][v]);
        return tn(this, { values: a }, !0).normalize();
      }),
      (t.negate = function() {
        if (!this.isValid) return this;
  ...
  function on(e) {
    if (W(e)) return rn.fromMillis(e);
    if (rn.isDuration(e)) return e;
    if ("object" == typeof e) return rn.fromObject(e);
      ...
      (e.invalid = function(t, n) {
        ...
        (e.fromISO = function(t, n) {
          ...
          if (i && o) {
            var a, u, s, c;
            try {
              u = (a = ar.fromISO(i, n)).isValid;
            } catch (o) {
              u = !1;
            }
            try {
              c = (s = ar.fromISO(o, n)).isValid;
            } catch (o) {
              c = !1;
            }
      ...
      return (
        ...
        (t.toFormat = function(e, t) {
          var n = (void 0 === t ? {} : t).separator,
            r = void 0 === n ? " – " : n;
          return this.isValid ? "" + this.s.toFormat(e) + r + this.e.toFormat(e) : an;
        }),
  ...
  function yn(e, t) {
    ...
    return void 0 === t && (t = ""), new RegExp("" + dn[n || "latn"] + t);
  }
  var vn = "missing Intl.DateTimeFormat.formatToParts support";
  function gn(e, t) {
    return (
      void 0 === t &&
        (t = function(e) {
            ...
            (function(e) {
              ...
              if (isNaN(t)) {
                ...
                for (var n = 0; n < e.length; n++) {
                  ...
                  if (-1 !== e[n].search(dn.hanidec)) t += mn.indexOf(e[n]);
                  else
                    for (var i in hn) {
                      var o = hn[i],
                        a = o[0],
  ...
  var pn = "( |" + String.fromCharCode(160) + ")",
    wn = new RegExp(pn, "g");
  function kn(e) {
    return e.replace(/\./g, "\\.?").replace(wn, pn);
  }
  function bn(e) {
    return e
      .replace(/\./g, "")
  ...
  function En(e, t) {
    ...
    var r = xe
      .create(t, n)
      .formatDateTimeParts((Nn || (Nn = ar.fromMillis(1555555555555)), Nn))
      .map(function(e) {
        ...
        return (
          ...
          ((v = (function(e) {
            ...
            switch (e.val) {
              ...
              case "Z":
              case "ZZ":
                return Sn(new RegExp("([+-]" + c.source + ")(?::(" + o.source + "))?"), 2);
              case "ZZZ":
                return Sn(new RegExp("([+-]" + c.source + ")(" + o.source + ")?"), 2);
              case "z":
  ...
  function Rn(e, t) {
    ...
    return new ar(Object.assign({}, n, t, { old: n }));
  }
  function Wn(e, t, n) {
    var r = e - 60 * t * 1e3,
      i = n.offset(r);
  ...
  function Gn(e, t, n, r, i) {
    ...
    if (e && 0 !== Object.keys(e).length) {
      var u = t || a,
        s = ar.fromObject(Object.assign(e, n, { zone: u, setZone: void 0 }));
      return o ? s : s.setZone(a);
    }
    return ar.invalid(new Ce("unparsable", 'the input "' + i + "\" can't be parsed as " + r));
  }
  function $n(e, t, n) {
    return (
      void 0 === n && (n = !0),
  ...
  function ir(e, t) {
    ...
    var o = _n(e) || qn(e);
    if (o) return ar.invalid(o);
    var a = Ke.now(),
      u = Jn(e, t.offset(a), t),
      s = u[0],
      l = u[1];
    return new ar({ ts: s, zone: t, o: l });
  }
  function or(e, t, n) {
  ...
  var ar = (function() {
    ...
    (e.now = function() {
      ...
      (e.fromJSDate = function(t, n) {
        ...
        var o = Pe(n.zone, Ke.defaultZone);
        return o.isValid ? new e({ ts: i, zone: o, loc: ct.fromObject(n) }) : e.invalid(Hn(o));
      }),
      (e.fromMillis = function(t, n) {
        if ((void 0 === n && (n = {}), W(t)))
          return t < -864e13 || t > 864e13
            ? e.invalid("Timestamp out of range")
            : new e({ ts: t, zone: Pe(n.zone, Ke.defaultZone), loc: ct.fromObject(n) });
        throw new v(
      ...
      (e.fromSeconds = function(t, n) {
        if ((void 0 === n && (n = {}), W(t)))
          return new e({ ts: 1e3 * t, zone: Pe(n.zone, Ke.defaultZone), loc: ct.fromObject(n) });
        throw new v("fromSeconds requires a numerical input");
      }),
      (e.fromObject = function(t) {
        var n = Pe(t.zone, Ke.defaultZone);
        if (!n.isValid) return e.invalid(Hn(n));
        var r = Ke.now(),
          i = n.offset(r),
          o = de(t, rr, ["zone", "locale", "outputCalendar", "numberingSystem"]),
          a = !R(o.ordinal),
          u = !R(o.year),
          s = !R(o.month) || !R(o.day),
          l = u || s,
      ...
      (e.fromISO = function(e, t) {
        ...
        return Gn(n[0], n[1], t, "ISO 8601", e);
      }),
      (e.fromRFC2822 = function(e, t) {
        ...
        return Gn(n[0], n[1], t, "RFC 2822", e);
      }),
      (e.fromHTTP = function(e, t) {
        void 0 === t && (t = {});
        var n = dt(e, [Ct, jt], [Ft, jt], [Zt, At]);
        return Gn(n[0], n[1], t, "HTTP", t);
      }),
      (e.fromFormat = function(t, n, r) {
        ...
        var i = r,
          ...
          f = c[1],
          d = c[2];
        return d ? e.invalid(d) : Gn(l, f, r, "format " + n, t);
      }),
    ...
    return (
      ...
      (t.setZone = function(t, n) {
        var r = void 0 === n ? {} : n,
          ...
          u = void 0 !== a && a;
        if ((t = Pe(t, Ke.defaultZone)).equals(this.zone)) return this;
        if (t.isValid) {
          var s = this.ts;
          if (o || u) {
            var c = t.offset(this.ts);
            s = Jn(this.toObject(), c, t)[0];
          }
          return Rn(this, { ts: s, zone: t });
        }
      ...
      (t.set = function(e) {
        ...
        !R(n.weekYear) || !R(n.weekNumber) || !R(n.weekday)
          ? (t = jn(Object.assign(Zn(this.c), n)))
          : R(n.ordinal)
            ? ((t = Object.assign(this.toObject(), n)),
              R(n.day) && (t.day = Math.min(oe(t.year, t.month), t.day)))
            : (t = zn(Object.assign(An(this.c), n)));
        var r = Jn(t, this.o, this.zone);
        return Rn(this, { ts: r[0], o: r[1] });
      }),
      (t.plus = function(e) {
        return this.isValid ? Rn(this, Yn(this, on(e))) : this;
      }),
      (t.minus = function(e) {
        return this.isValid ? Rn(this, Yn(this, on(e).negate())) : this;
      }),
      ...
      (t.toSQLTime = function(e) {
        var t = void 0 === e ? {} : e,
          ...
          r = void 0 === n || n,
          i = t.includeZone;
        return Bn(this, { includeOffset: r, includeZone: void 0 !== i && i, spaceZone: !0 });
      }),
      (t.toSQL = function(e) {
        return (
      ...
      (t.diff = function(e, t, n) {
        if (
          ...
          return rn.invalid(this.invalid || e.invalid, "created by diffing an invalid DateTime");
        var r,
      ...
      (e.fromFormatExplain = function(e, t, n) {
        ...
        var r = n,
          ...
          a = r.numberingSystem,
          u = void 0 === a ? null : a;
        return Dn(ct.fromOpts({ locale: o, numberingSystem: u, defaultToEN: !0 }), e, t);
      }),
      ...
      n(
        ...
        [
          ...
          },
          {
            ...
            get: function() {
              return this.isValid
                ? cn.months("short", { locale: this.locale })[this.month - 1]
                : null;
            }
          },
          {
            ...
            get: function() {
              return this.isValid
                ? cn.months("long", { locale: this.locale })[this.month - 1]
                : null;
            }
          },
          {
            ...
            get: function() {
              return this.isValid
                ? cn.weekdays("short", { locale: this.locale })[this.weekday - 1]
                : null;
            }
          },
          {
            ...
            get: function() {
              return this.isValid
                ? cn.weekdays("long", { locale: this.locale })[this.weekday - 1]
                : null;
            }
          },
          {
  ...
  function ur(e) {
    if (ar.isDateTime(e)) return e;
    if (e && e.valueOf && W(e.valueOf())) return ar.fromJSDate(e);
    if (e && "object" == typeof e) return ar.fromObject(e);
